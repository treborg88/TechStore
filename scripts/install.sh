#!/usr/bin/env bash
# =============================================================================
# Eonsclover — Fresh Server Installation Script
# =============================================================================
...
echo ""
echo "=============================================="
echo "  🛍️  Eonsclover — Server Installation"
echo "=============================================="
echo ""
...
# App path
ask "Installation path" "/home/$USER/Eonsclover"
APP_PATH="$REPLY"
...
# Eonsclover — Nginx config (Cloudflare Full Strict)
...
NGINXEOF
    ...
    sudo tee "$NGINX_AVAILABLE" > /dev/null << NGINXEOF
# Eonsclover — Nginx config (Cloudflare Flexible / HTTP only)
# Generated by install.sh on $(date -u +"%Y-%m-%d %H:%M UTC")
...
echo ""
echo "=============================================="
echo "  🎉  Eonsclover Installation Complete!"
echo "=============================================="
echo ""
